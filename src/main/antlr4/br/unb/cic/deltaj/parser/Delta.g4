/** 
 * A DeltaJ grammar for ANTLR v4, derived from Java grammar
 */
...
//starting point for parsing a Delta file
deltaCompilationUnit 
   : deltaDeclaration EOF
   ;

deltaDeclaration
   : 'delta' Identifier deltaBody
   ;	
